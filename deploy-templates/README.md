...
**Homepage:** <https://github.com/epmd-edp/python-python-flask.git>
...
* <https://github.com/epmd-edp/python-python-flask.git>
...
| framework | string | `"flask"` |  |
| fullnameOverride | string | `""` |  |
| image.pullPolicy | string | `"IfNotPresent"` |  |
| image.repository | string | `"flask-edp2"` |  |
